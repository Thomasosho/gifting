...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="/" class="p-5" style="background-color:#ffffff;"><img src="{{asset('images/gifting.png')}}" alt="logo"></a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item {{ (request()->is('cause')) ? 'active' : '' }}"><a href="/cause" class="nav-link">Causes</a></li>
          <li class="nav-item {{ (request()->is('donate')) ? 'active' : '' }}"><a href="/donate" class="nav-link">Donate</a></li>
